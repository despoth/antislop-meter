...
Шкала **0–10, где 10 — слопа нет**. Целевая планка — 8,5. Нижний якорь откалиброван на живом объекте: разобранный по кодам лендинг на 1,4 лежит в [`references/example-slop.md`](references/example-slop.md).
...
Старт 10 баллов, за каждую оставшуюся находку — штраф по тяжести: тяжёлая −1,5, средняя −0,8, лёгкая −0,3.
