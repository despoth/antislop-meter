...
Шкала **0–10, где 10 — слопа нет**. Целевая планка — 8,5. Нижний якорь откалиброван на живом объекте: разобранный по кодам лендинг на 1,0 лежит в [`references/example-slop.md`](references/example-slop.md).
...
| [`references/criteria.md`](references/criteria.md) | каталог: 160 критериев по 10 осям, у каждого признак, вес и чем заменить |
